...
class StartupReadyNotifier:
    """Run the splash-completion callback at most once.

    Qt owns the actual readiness signal because only the UI thread knows when
    the floating ball has been shown.  This tiny gate keeps retries or future
    alternate UI-ready hooks from closing the splash connection twice.
    """
    ...
    def notify(self) -> bool:
        """Invoke the completion callback once; return whether this call won."""
