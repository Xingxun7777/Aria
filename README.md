...
[![Version](https://img.shields.io/badge/version-1.0.3.19-blue.svg)](CHANGELOG.md)
...
| 版本 | 大小 | 说明 | 链接 |
|------|------|------|------|
| **精简版 (Lite)** | ~2 GB | 首次启动自动下载 ASR 模型 | [GitHub Releases](../../releases/latest) |
| **完整版 (Full)** | ~6 GB | 内置 ASR 模型，解压即用 | [百度网盘](https://pan.baidu.com/s/1rrDCiYiP_B57lmMXIpQlBg?pwd=34ti) 提取码 `34ti` · [夸克网盘](https://pan.quark.cn/s/3ac75d98458f) |
