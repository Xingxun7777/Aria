...
# Default model path relative to aria package. GGUF artifacts live in the
# dedicated models/llamacpp_gguf/ subdirectory (build allowlist keeps the
# models/ top level free of loose model files).
DEFAULT_MODEL_PATH = (
