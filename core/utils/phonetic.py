...
class PinyinMatcher:
    ...
    allowing tolerance for ASR transcription variants — homophones
    transcribed as different characters but sharing the same pinyin
    will match the configured target.
    """
    ...
    def find_match_at_start(
        ...
        Args:
            ...
            max_extra_chars: Allow this many extra characters for matching
                            (handles cases with trailing punctuation)
    ...
    def extract_wakeword(
        ...
        Args:
            ...
            wakeword: Target wakeword (the configured wake-up phrase)
