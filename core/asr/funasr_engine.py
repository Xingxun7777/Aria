    ...
    def transcribe(
        ...
        *,
        ...
        Args:
            ...
            pre_dsp_energy: Unused (signature aligned with ASREngine)
            pre_dsp_p95: Unused (signature aligned with ASREngine)
            capture_mode: Unused (signature aligned with ASREngine)

        Returns:
            ASRResult with transcribed text
        """
        del pre_dsp_energy, pre_dsp_p95, capture_mode  # accepted for API parity
